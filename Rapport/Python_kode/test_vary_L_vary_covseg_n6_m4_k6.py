...
""" Lists for variation """
#list_ = [166, 83, 10]      # for L = 1000
list_ = [416, 208, 10]    # for L = 2500
#list_ = [833, 250, 10]      # for L = 5000
...
plt.figure(1)
plt.plot(list_, errX)
plt.title('X error- vary cov_seg, n = 6, m = 4, true k = 6, L = 5000')
plt.xlabel('cov_seg')
plt.ylabel('Norm. mse of recovered X')
plt.savefig('Resultater/X_varying_covseg_L2500_n6_m4_k6.png')
#plt.savefig('Resultater/X_varying_covseg_L5000_n6_m4_k6.png')
plt.show()

plt.figure(2)
plt.plot(list_, errA)
plt.title('A error- vary cov_seg, n = 6, m = 4, true k = 6, L = 5000')
plt.xlabel('cov_seg')
plt.ylabel('Norm. mse of recovered A')
plt.savefig('Resultater/A_varying_covseg_L2500_n6_m4_k6.png')
#plt.savefig('Resultater/A_varying_covseg_L5000_n6_m4_k6.png')
plt.show()
