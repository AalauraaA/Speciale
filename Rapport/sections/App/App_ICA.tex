...
The purpose of this section is to verify the fast ICA algorithm which is used in this thesis. By this verification it is justified that ICA can be used a reference point with respect to performance of the developed main algorithm.
