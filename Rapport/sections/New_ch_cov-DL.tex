...
In the context of compressive sensing the matrix $\textbf{A}$ in the MMV model is referred to as the dictionary matrix. That is the true mixing matrix is estimated as a dictionary matrix, which can take different forms. This will elaborated further in the section of dictionary learning\todo{obs! stemmer dette på tværs a kapitlerne, vi siger A bliver estimeret som en dictionary.}.  
