...
\end{align*} 
where $(\cdot)^{\dagger}$ is the pseudo-inverse\todo{erstat * med hat også i algoritmen}.
...
Instead, when generating the support set $S_k$ one choose the $k$ largest entries of $\boldsymbol{\gamma}$ \cite[p. 3]{Balkan2014}.
