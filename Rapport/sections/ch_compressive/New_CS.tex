...
The assumption of $\textbf{X}$ being $M$-sparse corresponds to the number of active sources $k$ 
As discussed in chapter \ref{ch:motivation}, the aim of this thesis is to overcome the limitation of fewer sources than measurements, which is a limitation of compressive sensing \todo{Rasmus spørg om det før nævnte kan løses af compressive sensing?}. 
