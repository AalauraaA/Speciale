...
Consider the measurement matrix $\mathbf{Y} \in \mathbb{R}^{M \times L}$ consisting of measurement vectors $\lbrace \mathbf{y}_j \rbrace_j^L$ \todo{Rasmus spørger om dette er korret notation og det vil jeg mene det er - L} making a set of $L$ training examples forming a linear system
\begin{align*}
