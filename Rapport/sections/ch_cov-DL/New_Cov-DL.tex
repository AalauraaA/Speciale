...
Instead, by replacing the $\ell_0$-norm with the $\ell_1$-norm, the optimisation problem \eqref{eq:SMV_p0} can be approximated and hence becomes computationally feasible: \todo{3.3: skal vi indfør z som en approximation til x. og så et nyt omega eller? eller kan vi lade x* være løslingen til både P0 og P1}
...
\end{align*}
\end{theorem}
\todo{Skriv her hvad sætningen siger - Laura}
...
\end{proof}
\todo{Opsumering af hvad vi får fra beviset -- hvad siger det om vores optimeringsproblem? - Laura}
