...
For the measurements an EEG cap with $32$ sensors measuring the scalp EEG signal with sample frequency at $512$Hz\todo{tjek sample frequency and time} over a period of $XX$ seconds, resulting in $L = XX$ samples. 
