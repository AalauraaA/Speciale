\subsection{Test on EEG Data Set with $M=N$}
...
The last figure illustrate the $k = 15$ sources from $\hat{\mathbf{X}}_{\text{main}}$ and $\hat{\mathbf{X}}_{\text{ICA}}$ plot on each other.
\begin{figure}[H]
    \centering
