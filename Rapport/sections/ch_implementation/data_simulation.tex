...
As such the non-zero rows of $\mathbf{X}$ are mutually orthogonal\todo{Jan siger at rækkerne er independent men de er ikke nødvendigvis ortogonale medmindre de har zero mean - L}, which fulfils the first conditions of theorem \ref{th:conditions}.   
