...
By the sources being independent the rows of $\mathbf{X}$ becomes close to orthogonal \cite{Balkan2014}
...
, which approach the first conditions of theorem \ref{th:conditions}.   
