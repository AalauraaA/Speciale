...
This suggests that it is not a representative average behavior which has been visualized. 
...
To investigate this behavior the corresponding box-plot presenting the 500 repetitions for $N=9$ is visualized in figure \ref{fig:box}, respectively with and without outliers. 
