...
This suggest that the optimization problem, derived in section \ref{sec:over_det}, do not fulfil the purpose. \todo{insæt note om det kunne at det ikke er convex. da vi asumede problemet var convekst men kunne ikke tjekke det. evt. ref. til kap Cov.}
