...
From this model the aim is to identify both $\textbf{A}$ and $\textbf{X}$ given the measurements $\textbf{Y}$. This set up is in general referred to as the EEG inverse problem.  \\
\\
