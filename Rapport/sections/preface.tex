...
In appendix \ref{App:code} a list and outline of the scripts developed during this thesis can be found. The scripts are written in Python 3.6 and can be downloaded through GitHub link XX.
