...
The theme of this master thesis is mathematical modeling of EEG measurements for source recovery based on existing method, aiming to support existing the results.
...
In appendix \ref{App:code} a list and outline of the scripts developed during this thesis can be found. The scripts are written in Python 3.6 and are available at \url{https://github.com/TrineNyholm/Enclosure_Mattek10b_thesis_2020.git}.
